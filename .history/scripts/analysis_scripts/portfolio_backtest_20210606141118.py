...
_root = os.getcwd()
_data = os.path.join(_root, 'datasets\\portfolio\\')
portfolio_data_raw = pd.read_csv(_data + '\\portfolio_simple.csv')
...
def run(symbols, backtest_time):
	...
	print(comparison_df)
	comparison_df_analysed = os.path.join(_data, 'portfolio_comparison_analysed.csv')
